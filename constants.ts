...
/**
 * Problems are stored with difficulty in MOHS units:
 *   -60 = trivially easy for any math competition
 *     0 = average national competition
 *   +60 = hardest problems ever seen (IMO P6 ceiling)
 *
 * Stored in multiples of 5 and quantised per the MOHS update rule.
 */
export const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    topic: "Algebra",
    hints: [
      "Express the sides $a, b, c$ in terms of the circumradius $R$ and the angles $A, B, C$ using the Sine Rule (e.g., $a = 2R\\sin A$). Substitute these expressions into the given equation.",
